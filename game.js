...
const COLS = 8;
const WIN_ROUNDS = 2;
const BLOCK_COUNT = 10; // previous amount + 4 more
...
function buildRandomBoardAndSpawns() {
  ...
  const fallbackBlocks = [
    [1, 2, "crate"], [1, 5, "bush"], [2, 1, "crate"], [2, 6, "bush"], [3, 3, "crate"],
    [3, 5, "bush"], [4, 1, "crate"], [4, 6, "crate"], [0, 4, "bush"], [5, 3, "crate"]
  ];
  for (const [r, c, type] of fallbackBlocks) {
